...
function getLangDate(){
    ...
    document.getElementById("nowTime").innerHTML = /*"亲爱的" + */document.getElementById("userName").value + "，"+timeValue+"好！ 欢迎使用"+ document.getElementById("platformName").value +"。当前时间为： "+newDate+"　"+week;
...
layui.use(['form','element','layer','jquery'],function(){
    ...
    $.getJSON(ctx + "user/lastLoginTime", function (data) {
    ...
    //最新文章列表
    $.get(ctx + "news/content",function(data){
        var hotNewsHtml = '';
    ...
    //用户数量
    $.get(ctx + "user/users/count",function(data){
